...
-var "vpc_id=$VPC_ID" \
-var "subnet_database_1_cidr_block=$SUBNET_FOOD_CLIENT_DATABASE_1_CIDR_BLOCK" \
-var "subnet_database_2_cidr_block=$SUBNET_FOOD_CLIENT_DATABASE_2_CIDR_BLOCK" \
...
-var "db_username=$DB_FOOD_CLIENT_USERNAME" \
-var "db_password=$DB_FOOD_CLIENT_PASSWORD" \
-var "db_identifier=$DB_FOOD_CLIENT_IDENTIFIER" \
-var "db_name=$DB_FOOD_CLIENT_NAME" \
